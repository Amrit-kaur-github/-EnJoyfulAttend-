...
class Face_Recognition:
    def __init__ (self,root):
        ...
        img_top=Image.open(r"C:\Users\lenovo\OneDrive\Pictures\Saved Pictures\facial-recognition-system-woman-scanner-frame-face-information-186981643.webp")
        img_top=img_top.resize((765,700),Image.LANCZOS)
        self.photoimg_top=ImageTk.PhotoImage(img_top)

        f_lbl=Label(self.root,image=self.photoimg_top)
        f_lbl.place(x=0,y=55,width=765,height=700)
# 2nd image
        img_bottom=Image.open(r"C:\Users\lenovo\OneDrive\Pictures\Saved Pictures\facial_recognition_system_identification_digital_id_security_scanning_thinkstock_858236252_3x3-100740902-large.jpg")
...
# button
        ...
        btn.place(x=280,y=615,width=240,height=40)
